...
cmd:option('-epochSize',1100, 'epoch size')
...
--opt.save = rundir--opt.save = opt.save .. '/' .. rundir
...
dofile '../../code/deepsata_train/1_data.lua'
dofile '../../code/deepsata_train/2_model.lua'
dofile '../../code/deepsata_train/3_loss.lua'
dofile '../../code/deepsata_train/4_train.lua'
